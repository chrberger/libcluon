...
// Date: Tue, 06 Feb 2018 20:50:07 +0100
// Version: 0.0.41
//
//
...
const std::string TimeStamp::ShortName() {
    return "TimeStamp";
}
const std::string TimeStamp::LongName() {
    return "cluon.data.TimeStamp";
}

TimeStamp& TimeStamp::seconds(const int32_t &v) noexcept {
    m_seconds = v;
    return *this;
}
int32_t TimeStamp::seconds() const noexcept {
    return m_seconds;
}

TimeStamp& TimeStamp::microseconds(const int32_t &v) noexcept {
    m_microseconds = v;
    return *this;
}
int32_t TimeStamp::microseconds() const noexcept {
...
uint32_t Envelope::ID() {
    return 1;
}

const std::string Envelope::ShortName() {
    return "Envelope";
}
const std::string Envelope::LongName() {
    return "cluon.data.Envelope";
}

Envelope& Envelope::dataType(const int32_t &v) noexcept {
    m_dataType = v;
    return *this;
}
int32_t Envelope::dataType() const noexcept {
    return m_dataType;
}

Envelope& Envelope::serializedData(const std::string &v) noexcept {
    m_serializedData = v;
    return *this;
}
std::string Envelope::serializedData() const noexcept {
    return m_serializedData;
}

Envelope& Envelope::sent(const cluon::data::TimeStamp &v) noexcept {
    m_sent = v;
    return *this;
}
cluon::data::TimeStamp Envelope::sent() const noexcept {
    return m_sent;
}

Envelope& Envelope::received(const cluon::data::TimeStamp &v) noexcept {
    m_received = v;
    return *this;
}
cluon::data::TimeStamp Envelope::received() const noexcept {
    return m_received;
}

Envelope& Envelope::sampleTimeStamp(const cluon::data::TimeStamp &v) noexcept {
    m_sampleTimeStamp = v;
    return *this;
}
cluon::data::TimeStamp Envelope::sampleTimeStamp() const noexcept {
    return m_sampleTimeStamp;
}

Envelope& Envelope::senderStamp(const uint32_t &v) noexcept {
    m_senderStamp = v;
    return *this;
}
uint32_t Envelope::senderStamp() const noexcept {
...
void ToProtoVisitor::preVisit(uint32_t id, const std::string &shortName, const std::string &longName) noexcept {
    (void)id;
    (void)shortName;
    (void)longName;
}
