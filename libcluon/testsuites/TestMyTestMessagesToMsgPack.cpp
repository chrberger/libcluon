...
TEST_CASE("Testing MyTestMessage4 of size 0xdb.") {
    ...
    std::string value;
    for (uint32_t i = 0; i < std::numeric_limits<uint32_t>::max() + 2; i++) { value += "A"; }
...
TEST_CASE("Testing MyTestMessage5 with positive intX values.") {
    testdata::MyTestMessage5 tmp;
    ...
    REQUIRE(3 == tmp.attribute1());
    REQUIRE(2 == tmp.attribute2());
    REQUIRE(103 == tmp.attribute3());
    REQUIRE(203 == tmp.attribute4());
    REQUIRE(10003 == tmp.attribute5());
    ...
    REQUIRE(0x65 == static_cast<uint8_t>(s.at(22)));
    REQUIRE(0x32 == static_cast<uint8_t>(s.at(23)));
    REQUIRE(0x2 == static_cast<uint8_t>(s.at(24)));
    REQUIRE(0xaa == static_cast<uint8_t>(s.at(25)));
    REQUIRE(0x61 == static_cast<uint8_t>(s.at(26)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(27)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(28)));
    ...
    REQUIRE(0x65 == static_cast<uint8_t>(s.at(46)));
    REQUIRE(0x34 == static_cast<uint8_t>(s.at(47)));
    REQUIRE(0xcc == static_cast<uint8_t>(s.at(48)));
    REQUIRE(0xcb == static_cast<uint8_t>(s.at(49)));
    REQUIRE(0xaa == static_cast<uint8_t>(s.at(50)));
    REQUIRE(0x61 == static_cast<uint8_t>(s.at(51)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(52)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(53)));
    ...
    REQUIRE(0x65 == static_cast<uint8_t>(s.at(73)));
    REQUIRE(0x36 == static_cast<uint8_t>(s.at(74)));
    REQUIRE(0xcd == static_cast<uint8_t>(s.at(75)));
    REQUIRE(0x4e == static_cast<uint8_t>(s.at(76)));
    REQUIRE(0x23 == static_cast<uint8_t>(s.at(77)));
    REQUIRE(0xaa == static_cast<uint8_t>(s.at(78)));
    REQUIRE(0x61 == static_cast<uint8_t>(s.at(79)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(80)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(81)));
    ...
    REQUIRE(0x65 == static_cast<uint8_t>(s.at(101)));
    REQUIRE(0x38 == static_cast<uint8_t>(s.at(102)));
    REQUIRE(0xcd == static_cast<uint8_t>(s.at(103)));
    REQUIRE(0xad == static_cast<uint8_t>(s.at(104)));
    REQUIRE(0x21 == static_cast<uint8_t>(s.at(105)));
    REQUIRE(0xaa == static_cast<uint8_t>(s.at(106)));
    REQUIRE(0x61 == static_cast<uint8_t>(s.at(107)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(108)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(109)));
    REQUIRE(0x72 == static_cast<uint8_t>(s.at(110)));
    REQUIRE(0x69 == static_cast<uint8_t>(s.at(111)));
    REQUIRE(0x62 == static_cast<uint8_t>(s.at(112)));
    REQUIRE(0x75 == static_cast<uint8_t>(s.at(113)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(114)));
    REQUIRE(0x65 == static_cast<uint8_t>(s.at(115)));
    REQUIRE(0x39 == static_cast<uint8_t>(s.at(116)));
    REQUIRE(0xca == static_cast<uint8_t>(s.at(117)));
    REQUIRE(0xc0 == static_cast<uint8_t>(s.at(118)));
    REQUIRE(0xad == static_cast<uint8_t>(s.at(119)));
    REQUIRE(0xd3 == static_cast<uint8_t>(s.at(120)));
    REQUIRE(0xc3 == static_cast<uint8_t>(s.at(121)));
    REQUIRE(0xab == static_cast<uint8_t>(s.at(122)));
    REQUIRE(0x61 == static_cast<uint8_t>(s.at(123)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(124)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(125)));
    REQUIRE(0x72 == static_cast<uint8_t>(s.at(126)));
    REQUIRE(0x69 == static_cast<uint8_t>(s.at(127)));
    REQUIRE(0x62 == static_cast<uint8_t>(s.at(128)));
    REQUIRE(0x75 == static_cast<uint8_t>(s.at(129)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(130)));
    REQUIRE(0x65 == static_cast<uint8_t>(s.at(131)));
    REQUIRE(0x31 == static_cast<uint8_t>(s.at(132)));
    REQUIRE(0x30 == static_cast<uint8_t>(s.at(133)));
    REQUIRE(0xcb == static_cast<uint8_t>(s.at(134)));
    REQUIRE(0xc0 == static_cast<uint8_t>(s.at(135)));
    REQUIRE(0x49 == static_cast<uint8_t>(s.at(136)));
    REQUIRE(0x37 == static_cast<uint8_t>(s.at(137)));
    REQUIRE(0x4f == static_cast<uint8_t>(s.at(138)));
    REQUIRE(0xd == static_cast<uint8_t>(s.at(139)));
    REQUIRE(0x84 == static_cast<uint8_t>(s.at(140)));
    REQUIRE(0x4d == static_cast<uint8_t>(s.at(141)));
    REQUIRE(0x1 == static_cast<uint8_t>(s.at(142)));
    REQUIRE(0xab == static_cast<uint8_t>(s.at(143)));
    REQUIRE(0x61 == static_cast<uint8_t>(s.at(144)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(145)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(146)));
    REQUIRE(0x72 == static_cast<uint8_t>(s.at(147)));
    REQUIRE(0x69 == static_cast<uint8_t>(s.at(148)));
    REQUIRE(0x62 == static_cast<uint8_t>(s.at(149)));
    REQUIRE(0x75 == static_cast<uint8_t>(s.at(150)));
    REQUIRE(0x74 == static_cast<uint8_t>(s.at(151)));
    REQUIRE(0x65 == static_cast<uint8_t>(s.at(152)));
    REQUIRE(0x31 == static_cast<uint8_t>(s.at(153)));
    REQUIRE(0x31 == static_cast<uint8_t>(s.at(154)));
    REQUIRE(0xb2 == static_cast<uint8_t>(s.at(155)));
    REQUIRE(0x48 == static_cast<uint8_t>(s.at(156)));
    REQUIRE(0x65 == static_cast<uint8_t>(s.at(157)));
    REQUIRE(0x6c == static_cast<uint8_t>(s.at(158)));
    REQUIRE(0x6c == static_cast<uint8_t>(s.at(159)));
    REQUIRE(0x6f == static_cast<uint8_t>(s.at(160)));
    REQUIRE(0x20 == static_cast<uint8_t>(s.at(161)));
    REQUIRE(0x63 == static_cast<uint8_t>(s.at(162)));
    REQUIRE(0x6c == static_cast<uint8_t>(s.at(163)));
    REQUIRE(0x75 == static_cast<uint8_t>(s.at(164)));
    REQUIRE(0x6f == static_cast<uint8_t>(s.at(165)));
    REQUIRE(0x6e == static_cast<uint8_t>(s.at(166)));
    REQUIRE(0x20 == static_cast<uint8_t>(s.at(167)));
    REQUIRE(0x57 == static_cast<uint8_t>(s.at(168)));
    REQUIRE(0x6f == static_cast<uint8_t>(s.at(169)));
    REQUIRE(0x72 == static_cast<uint8_t>(s.at(170)));
    REQUIRE(0x6c == static_cast<uint8_t>(s.at(171)));
    REQUIRE(0x64 == static_cast<uint8_t>(s.at(172)));
    REQUIRE(0x21 == static_cast<uint8_t>(s.at(173)));
