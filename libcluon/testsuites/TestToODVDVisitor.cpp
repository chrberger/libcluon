...
TEST_CASE("Testing MyTestMessage12 for non-consecutive IDs.") {
    testdata::MyTestMessage12 tmp;

    tmp.attribute12(-9.123456f).attribute13(10.123456789);
    ...
    REQUIRE(-3 == tmp.attribute5());
    REQUIRE(4 == tmp.attribute6());
    REQUIRE(-5 == tmp.attribute9());
    REQUIRE(6 == tmp.attribute8());
    REQUIRE(-7 == tmp.attribute10());
    REQUIRE(8 == tmp.attribute11());
    REQUIRE(-9.123456 == Approx(tmp.attribute12()));
    REQUIRE(10.123456789 == Approx(tmp.attribute13()));
    REQUIRE("Hello World" == tmp.attribute14());
    REQUIRE("Hello Galaxy" == tmp.attribute15());
    ...
    const char *msg = R"(message testdata.MyTestMessage12 [ id = 30012 ] {
    bool attribute1 [ default = false, id = 1 ];
    char attribute2 [ default = '0', id = 2 ];
    int8 attribute3 [ default = 0, id = 3 ];
    uint8 attribute4 [ default = 0, id = 4 ];
    int16 attribute5 [ default = 0, id = 5 ];
    uint16 attribute6 [ default = 0, id = 6 ];
    int32 attribute9 [ default = 0, id = 9 ];
    uint32 attribute8 [ default = 0, id = 8 ];
    int64 attribute10 [ default = 0, id = 10 ];
    uint64 attribute11 [ default = 0, id = 11 ];
    float attribute12 [ default = 0.0, id = 12 ];
    double attribute13 [ default = 0.0, id = 13 ];
    string attribute14 [ default = "", id = 14 ];
    string attribute15 [ default = "", id = 15 ];
}
)";
...
"attribute10":-7,
"attribute11":8,
"attribute12":-9.123456,
"attribute13":10.123456789,
